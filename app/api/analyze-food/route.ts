...
// App Router route handlers have no `bodyParser` config knob (that was a Pages Router API).
// Large payloads are kept out by client-side image resize plus this hard cap on the base64 string.
